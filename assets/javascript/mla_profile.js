const mla_name = JSON.parse(localStorage.getItem("mla_details_tamil"));
...
if (found) {
  ...
  iframe.src = mla_name[i].affidate;
  ...
  list1img.setAttribute(
    "src",
    "https://freeimghost.net/images/2023/05/13/not-iamge.jpeg"
  );
